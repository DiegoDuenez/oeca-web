<div class="nosotros">
    ...
    <div class="nosotros__card-row">
        <div class="nosotros__card-container">
        ...
        <div class="nosotros__card-container">
            <img src="resources/img/valores.png" alt="" class="nosotros__card-img-top">
            <div class="nosotros__card">
                <div class="nosotros__card-text">
                   <ul>
                        <li><i class="fa-solid fa-circle"></i> Tenacidad</li>
                        <li><i class="fa-solid fa-circle"></i> Bienestar</li>
                        <li><i class="fa-solid fa-circle"></i> Disciplina</li>
                        <li><i class="fa-solid fa-circle"></i> Calidez humana</li>
                        <li><i class="fa-solid fa-circle"></i> Honestidad</li>
                   </ul>
                </div>
            </div>
            <div class="nosotros__card-img-bottom">
